...
@Component({
  selector: 'al-create-symptom-container',
  templateUrl: './create-symptom-container.component.html'
})
export class CreateSymptomContainerComponent extends CudCreateBase implements OnInit, ICudCreate {
